...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1 = w1[:48,:2]
        w2 = w2[:4,:8]
        self.conv1.conv1d_stride1.W = np.transpose(np.reshape(np.transpose(w1), (2,2,24)),(0,2,1))
        self.conv2.conv1d_stride1.W = np.transpose(np.reshape(np.transpose(w2), (8,2,2)),(0,2,1))
